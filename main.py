...
class CashCalculator(Calculator):
    ...
    def get_today_cash_remained(self, currency,
        ...
        if cash_remained > 0:
            ...
            И так же данное условие при не выполнении условий
            cash_remained > 0 и cash_remained < 0, можно вернуть в конце
            функции, не проводя проверку на cash_remained == 0
            """
